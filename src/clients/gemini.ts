  ...
  async scoreCompanies(
    ...
    for (const batch of batches) {
      ...
      const prompt = [
        ...
        "  HIGH: Operating in Nigeria, South Africa, Ghana, Cameroon, Zambia, Tanzania, Morocco, or Egypt; building a financial product; seed/Series A funding or fresh product launch",
        "  MEDIUM: Right product type but no funding trigger — OR geography is Kenya, Senegal, Ivory Coast, Uganda, Angola, Rwanda, Ethiopia, DRC, or any other XAF/XOF zone country",
        "",
        ...
        "  HIGH: Company in or serving Nigeria, Kenya, South Africa, Ghana, Cameroon, Zambia, Tanzania, Morocco, Egypt, Ethiopia, Zimbabwe, Sudan, or any country in the Middle East, South/Southeast Asia, or Latin America where USD access is restricted or local currency is volatile — wanting to issue dollar cards; OR any company in these markets needing to pay international vendors",
        "  MEDIUM: Global card issuer expanding to any of these markets; company where card need is likely but not explicitly stated",
        "",
